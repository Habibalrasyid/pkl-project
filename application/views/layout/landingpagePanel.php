  ...
  <footer class="page-footer indigo darken-3 text-center text-md-left pt-5">
    ...
    <div class="container mb-3">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 ml-lg-auto col-md-4 mt-1 mb-1 wow fadeIn" data-wow-delay="0.3s">
          ...
          <!--Info-->
          <p><i class="fas fa-home pr-1"></i> <?php echo (!empty($kontak['alamat']) ? $kontak['alamat'] : 'Jl. KHR. Syamsul Arifin, Sukorejo, Kec. Banyuputih, Kabupaten Situbondo, Jawa Timur 68374'); ?></p>
          <p><i class="fas fa-envelope pr-1"></i> <?php echo (!empty($kontak['email']) ? $kontak['email'] : 'sainstekunib@gmail.com'); ?></p>
          <p><i class="fas fa-phone pr-1"></i> <?php echo (!empty($kontak['no_telp']) ? $kontak['no_telp'] : '(033)84550004'); ?></p>
          <p><i class="fas fa-print pr-1"></i> <?php echo (!empty($kontak['no_fax']) ? $kontak['no_fax'] : '(033)84550004'); ?></p>
        ...
        <div class="col-lg-3 ml-lg-auto col-md-4 mt-1 mb-1 wow fadeIn" data-wow-delay="0.3s">
         ...
         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.365455722116!2d114.27250831539541!3d-7.751006779002353!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd129da74aac20d%3A0xa21409e829d88ddd!2sFakultas%20Sains%20Dan%20Teknologi%20Universitas%20Ibrahimy!5e0!3m2!1sid!2sid!4v1675263380086!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          '); ?>
          </div>
          <!--Google Maps-->
    ...
    <div class="footer-copyright py-3 text-center">
      <div class="container-fluid">
        © 2023 Copyright: <a href="https://saintek-ibrahimy.ac.id/" target="_blank"> UNIVERSITAS IBRAHIMY II SAINTEK </a>
      </div>
    </div>
    <!--/Copyright-->
