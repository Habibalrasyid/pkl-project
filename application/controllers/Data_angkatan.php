...
class Data_angkatan extends CI_Controller
{
    ...
    public function data_angkatan_read($id)
    {
        ...
        if (isset($row['id_data_diri'])) {
            // var_dump($row['id_data_diri']);
            // echo "<br>";
            // echo "<br>";
            // echo "<br>";
            // echo "<br>";
            $datadiri = $this->Main_model->view_join_where('data_diri', 'users', 'id_user', 'id', 'id_data_diri', $row['id_data_diri'], 'id_data_diri',  'Desc')->row_array();
            // var_dump($datadiri);
            // die();
